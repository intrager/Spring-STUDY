...
@Component class Engine {}	// @Component 지우면 engine에 null 들어감
...
class AppContext {
	...
	private void doComponentScan() {
		try {
			...
			Set<ClassPath.ClassInfo> set = classPath.getTopLevelClasses("com.study.ch3.diCopy4");
	...
	Object getBean(String key) {
		return map.get(key);	// key를 주면 그 키에 해당하는 값 반환
	}
