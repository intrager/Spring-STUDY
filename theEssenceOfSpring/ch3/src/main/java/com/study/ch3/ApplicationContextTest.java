...
//		Car car = ac.getBean("car", Car.class);	// 타입을 지정하면 형변환 안 해도 됨. 아래 문장과 동일함
	    ...
	    // getBeanNamesForAnnotation() 얘는 spring-context 3.1.1버전에서는 안 되고, 5.3.18버전에서 되는 걸 확인
		...
		System.out.println("ac.getBeanNamesForType(Engine.class) = " + Arrays.toString(ac.getBeanNamesForType(Engine.class)));
	}
}
