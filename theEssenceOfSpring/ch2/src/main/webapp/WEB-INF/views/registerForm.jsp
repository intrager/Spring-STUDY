...
<body>
	...
	<form:form modelAttribute="user">
		...
		<label for="">이름</label>
		<input class="input-field" type="text" name="name" placeholder="한정수">
		<label for="">이메일</label>
		<input class="input-field" type="text" name="email" placeholder="example@study.co.kr">
		<label for="">생일</label>
		<input class="input-field" type="text" name="birth" placeholder="2022/7/17">
		<label for="">취미</label>
	...
	<script>
		function formCheck(frm) {
			...
			if(frm.pw.value.length < 3) {
				setMessage('pw의 길이는 3자 이상이어야 합니다.', frm.pw);
				return false;
			}
